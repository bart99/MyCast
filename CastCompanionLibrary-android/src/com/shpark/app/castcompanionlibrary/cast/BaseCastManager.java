...
import com.shpark.app.castcompanionlibrary.cast.callbacks.IBaseCastConsumer;
...
public abstract class BaseCastManager implements DeviceSelectionListener, ConnectionCallbacks,
    ...
    protected BaseCastManager(Context context, String applicationId) {
        CCL_VERSION = context.getString(com.shpark.app.castcompanionlibrary.R.string.ccl_version);
    ...
    /**
     * This is called from {@link CastMediaRouterCallback}
     ...
     *     {@link com.shpark.app.castcompanionlibrary.cast.callbacks.VideoCastConsumerImpl}
...
public void onCastAvailabilityChanged(boolean castPresent) {
        ...
        if (canConsiderSessionRecovery(context)) {
            ...
            mReconnectionTask = new AsyncTask<Void, Integer, Integer>() {
                ...
                protected void onPreExecute() {
                    ...
                    dlg.setMessage(context.getString(com.shpark.app.castcompanionlibrary.R.string.session_reconnection_attempt));
    ...
    public void onConnectionFailed(ConnectionResult result) {
        ...
        if (showError) {
            Utils.showErrorDialog(mContext, com.shpark.app.castcompanionlibrary.R.string.failed_to_connect);
        }
    }
     ...
     *
     * @see com.shpark.app.castcompanionlibrary.cast.callbacks.BaseCastConsumerImpl
     * @param listener
     */
