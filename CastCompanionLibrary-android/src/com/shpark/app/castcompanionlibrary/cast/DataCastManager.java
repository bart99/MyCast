...
import com.shpark.app.castcompanionlibrary.cast.callbacks.IDataCastConsumer;
 ...
 * it provides (see {@link com.shpark.app.castcompanionlibrary.cast.callbacks.IDataCastConsumer}). Since the number of these callbacks is usually much
 * larger than what a single application might be interested in, there is a no-op implementation of
 * this interface (see {@link com.shpark.app.castcompanionlibrary.cast.callbacks.DataCastConsumerImpl}) that applications can subclass to override only
...
public class DataCastManager extends BaseCastManager
    ...
    public static DataCastManager getInstance() throws CastException {
        if (null == sInstance) {
            LogUtils.LOGE(TAG, "No DataCastManager instance was initialized, you need to " +
     ...
     * @param namespace
     * @return
     * @throws com.shpark.app.castcompanionlibrary.cast.exceptions.NoConnectionException If no connectivity to the device exists
     * @throws com.shpark.app.castcompanionlibrary.cast.exceptions.TransientNetworkDisconnectionException If framework is still trying to recover from a
     ...
     *
     * @see com.shpark.app.castcompanionlibrary.cast.callbacks.DataCastConsumerImpl
     * @param listener
     */
    public void addDataCastConsumer(IDataCastConsumer listener) {
        if (null != listener) {
            ...
            if (result) {
                ...
                LogUtils.LOGD(TAG, "Adding Listener " + listener + " was already registered, " +
                        "skipping this step");
            }
        }
    }
