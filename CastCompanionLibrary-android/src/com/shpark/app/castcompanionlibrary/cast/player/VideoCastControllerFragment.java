...
package com.shpark.app.castcompanionlibrary.cast.player;
...
public class VideoCastControllerFragment extends Fragment implements OnVideoCastControllerListener,
        ...
        if (extras.getBoolean(VideoCastManager.EXTRA_HAS_AUTH)) {
            ...
            if (!TextUtils.isEmpty(customDataStr)) {
                try {
                    ...
                    LogUtils.LOGE(TAG, "Failed to unmarshalize custom data string: customData="
                            + customDataStr, e);
                }
            }
            ...
            public void run() {
                if (null != authService) {
                    try {
                        ...
                        LogUtils.LOGE(TAG, "mAuthService.start() encountered exception", e);
                        mAuthSuccess = false;
                    }
                }
            }
    ...
    class MediaAuthServiceTimerTask extends TimerTask {
        ...
        public void run() {
            if (null != mThread) {
                LogUtils.LOGD(TAG, "Timer is expired, going to interrupt the thread");
                mThread.interrupt();
                mHandler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        showErrorDialog(getString(com.shpark.app.castcompanionlibrary.R.string.failed_authorization_timeout));
                        mAuthSuccess = false;
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        LogUtils.LOGE(TAG, "Failed to update the progress bar due to network issues", e);
                    } catch (NoConnectionException e) {
                        LogUtils.LOGE(TAG, "Failed to update the progress bar due to network issues", e);
                    }
    ...
    private void updatePlayerStatus() {
        ...
        if (mediaStatus == MediaStatus.PLAYER_STATE_BUFFERING) {
            mCastController.setLine2(getString(com.shpark.app.castcompanionlibrary.R.string.loading));
        } else {
            mCastController.setLine2(getString(com.shpark.app.castcompanionlibrary.R.string.casting_to_device,
        ...
        mImageAsyncTask = new AsyncTask<String, Void, Bitmap>() {
            ...
            protected Bitmap doInBackground(String... params) {
                ...
                try {
                    ...
                    LogUtils.LOGE(TAG, "Failed to load the image with mUrl: " + uri, e);
                }
                return null;
            }
    ...
    public static class ErrorDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    .setTitle(com.shpark.app.castcompanionlibrary.R.string.error)
                    .setMessage(message)
                    .setPositiveButton(com.shpark.app.castcompanionlibrary.R.string.ok, new DialogInterface.OnClickListener() {
    ...
    public void onPlayPauseClicked(View v) throws CastException,
        ...
        LogUtils.LOGD(TAG, "isConnected returning: " + mCastManager.isConnected());
        togglePlayback();
    }
