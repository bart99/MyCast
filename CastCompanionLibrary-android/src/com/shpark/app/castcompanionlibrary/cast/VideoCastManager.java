...
package com.shpark.app.castcompanionlibrary.cast;

import static com.shpark.app.castcompanionlibrary.utils.LogUtils.LOGD;
import static com.shpark.app.castcompanionlibrary.utils.LogUtils.LOGE;
...
import com.shpark.app.castcompanionlibrary.cast.callbacks.IVideoCastConsumer;
import com.shpark.app.castcompanionlibrary.cast.dialog.video.VideoMediaRouteDialogFactory;
import com.shpark.app.castcompanionlibrary.cast.exceptions.CastException;
import com.shpark.app.castcompanionlibrary.cast.exceptions.NoConnectionException;
import com.shpark.app.castcompanionlibrary.cast.exceptions.OnFailedListener;
import com.shpark.app.castcompanionlibrary.cast.exceptions.TransientNetworkDisconnectionException;
import com.shpark.app.castcompanionlibrary.cast.player.IMediaAuthService;
import com.shpark.app.castcompanionlibrary.cast.player.VideoCastControllerActivity;
import com.shpark.app.castcompanionlibrary.notification.VideoCastNotificationService;
import com.shpark.app.castcompanionlibrary.remotecontrol.RemoteControlClientCompat;
import com.shpark.app.castcompanionlibrary.remotecontrol.RemoteControlHelper;
import com.shpark.app.castcompanionlibrary.remotecontrol.VideoIntentReceiver;
import com.shpark.app.castcompanionlibrary.utils.LogUtils;
import com.shpark.app.castcompanionlibrary.utils.Utils;
import com.shpark.app.castcompanionlibrary.widgets.IMiniController;
import com.shpark.app.castcompanionlibrary.widgets.MiniController;
 ...
 * </ul>
 * Callers can add {@link com.shpark.app.castcompanionlibrary.widgets.MiniController} components to their application pages by adding the
 ...
 * (see {@link com.shpark.app.castcompanionlibrary.cast.callbacks.IVideoCastConsumer}). Since the number of these callbacks is usually much larger
 * than what a single application might be interested in, there is a no-op implementation of this
 * interface (see {@link com.shpark.app.castcompanionlibrary.cast.callbacks.VideoCastConsumerImpl}) that applications can subclass to override only
...
public class VideoCastManager extends BaseCastManager
        implements MiniController.OnMiniControllerChangedListener, OnFailedListener {
     ...
     * {@link com.shpark.app.castcompanionlibrary.cast.exceptions.CastException} exception.
     *
     * @param context
     ...
     * {@link com.shpark.app.castcompanionlibrary.cast.exceptions.CastException} will be thrown.
     *
     * @return
     * @throws com.shpark.app.castcompanionlibrary.cast.exceptions.CastException
     * @see initialize()
     */
     ...
     *
     * @throws com.shpark.app.castcompanionlibrary.cast.exceptions.TransientNetworkDisconnectionException
     * @throws com.shpark.app.castcompanionlibrary.cast.exceptions.NoConnectionException
     */
    private void updateMiniController(IMiniController controller)
        ...
        if (mRemoteMediaPlayer.getStreamDuration() > 0 || isRemoteStreamLive()) {
            ...
            controller.setSubTitle(mContext.getResources().getString(com.shpark.app.castcompanionlibrary.R.string.casting_to_device,
                    mDeviceName));
    ...
    public void startCastControllerActivity(Context ctx,
            MediaInfo mediaInfo, int position, boolean shouldStart, JSONObject customData) {
        startCastControllerActivity(ctx, Utils.fromMediaInfo(mediaInfo), position, shouldStart, customData);
    }
                    ...
                    new ResultCallback<RemoteMediaPlayer.MediaChannelResult>() {
                        ...
                        public void onResult(MediaChannelResult result) {
                            if (!result.getStatus().isSuccess()) {
                                onFailed(com.shpark.app.castcompanionlibrary.R.string.failed_setting_volume,
    ...
    private void onApplicationStatusChanged() {
        ...
        try {
            ...
            LogUtils.LOGD(TAG, "onApplicationStatusChanged() reached: "
        ...
        try {
            ...
            mRemoteMediaPlayer.requestStatus(mApiClient).
                    setResultCallback(new ResultCallback<RemoteMediaPlayer.MediaChannelResult>() {
                        ...
                        public void onResult(MediaChannelResult result) {
                            if (!result.getStatus().isSuccess()) {
                                onFailed(com.shpark.app.castcompanionlibrary.R.string.failed_status_request,
                                        result.getStatus().getStatusCode());
                            }
            ...
            onFailed(com.shpark.app.castcompanionlibrary.R.string.failed_no_connection_trans, NO_STATUS_CODE);
        } catch (NoConnectionException e) {
            LogUtils.LOGE(TAG, "Failed to attach media/data channel due to network issues", e);
            onFailed(com.shpark.app.castcompanionlibrary.R.string.failed_no_connection, NO_STATUS_CODE);
        }
    ...
    /*
     * (non-Javadoc)
     * @see BaseCastManager# onConnectivityRecovered()
     */
    @Override
            ...
            if (showError) {
                switch (errorCode) {
                    case CastStatusCodes.APPLICATION_NOT_FOUND:
                        LogUtils.LOGD(TAG, "onApplicationConnectionFailed(): failed due to: " +
                                "ERROR_APPLICATION_NOT_FOUND");
                        Utils.showErrorDialog(mContext, com.shpark.app.castcompanionlibrary.R.string.failed_to_find_app);
                        break;
                    case CastStatusCodes.TIMEOUT:
                        LogUtils.LOGD(TAG, "onApplicationConnectionFailed(): failed due to: ERROR_TIMEOUT");
                        Utils.showErrorDialog(mContext, com.shpark.app.castcompanionlibrary.R.string.failed_app_launch_timeout);
                        break;
                    default:
                        LogUtils.LOGD(TAG, "onApplicationConnectionFailed(): failed due to: errorcode="
                                + errorCode);
                        Utils.showErrorDialog(mContext, com.shpark.app.castcompanionlibrary.R.string.failed_to_launch_app);
                        break;
                }
            }
...
//        LOGD(TAG, "loadMedia: " + media);
        ...
        mRemoteMediaPlayer.load(mApiClient, media, autoPlay, position, customData)
                .setResultCallback(new ResultCallback<RemoteMediaPlayer.MediaChannelResult>() {
                    ...
                    public void onResult(MediaChannelResult result) {
                        if (!result.getStatus().isSuccess()) {
                            onFailed(com.shpark.app.castcompanionlibrary.R.string.failed_load, result.getStatus().getStatusCode());
                        }
    ...
    public void play(JSONObject customData) throws
        ...
        mRemoteMediaPlayer.play(mApiClient, customData)
                .setResultCallback(new ResultCallback<MediaChannelResult>() {
                    ...
                    public void onResult(MediaChannelResult result) {
                        if (!result.getStatus().isSuccess()) {
                            onFailed(com.shpark.app.castcompanionlibrary.R.string.failed_to_play, result.getStatus().getStatusCode());
                        }
                    }
    ...
    public void stop(JSONObject customData) throws
        ...
        mRemoteMediaPlayer.stop(mApiClient, customData).setResultCallback(
                new ResultCallback<MediaChannelResult>() {
                    ...
                    public void onResult(MediaChannelResult result) {
                        if (!result.getStatus().isSuccess()) {
                            onFailed(com.shpark.app.castcompanionlibrary.R.string.failed_to_stop, result.getStatus().getStatusCode());
                        }
                    }
    ...
    public void pause(JSONObject customData) throws
        ...
        mRemoteMediaPlayer.pause(mApiClient, customData)
                .setResultCallback(new ResultCallback<MediaChannelResult>() {
                    ...
                    public void onResult(MediaChannelResult result) {
                        if (!result.getStatus().isSuccess()) {
                            onFailed(com.shpark.app.castcompanionlibrary.R.string.failed_to_pause, result.getStatus().getStatusCode());
                        }
                    }
    ...
    public void seek(int position) throws TransientNetworkDisconnectionException,
        ...
        mRemoteMediaPlayer.seek(mApiClient,
                ...
                setResultCallback(new ResultCallback<MediaChannelResult>() {
                    ...
                    public void onResult(MediaChannelResult result) {
                        if (!result.getStatus().isSuccess()) {
                            onFailed(com.shpark.app.castcompanionlibrary.R.string.failed_seek, result.getStatus().getStatusCode());
                        }
                    }
            ...
            mRemoteMediaPlayer.setOnStatusUpdatedListener(
                    new RemoteMediaPlayer.OnStatusUpdatedListener() {
                        ...
                        public void onStatusUpdated() {
                            LogUtils.LOGD(TAG, "RemoteMediaPlayer::onStatusUpdated() is reached");
            ...
            mRemoteMediaPlayer.setOnMetadataUpdatedListener(
                    new RemoteMediaPlayer.OnMetadataUpdatedListener() {
                        ...
                        public void onMetadataUpdated() {
                            LogUtils.LOGD(TAG, "RemoteMediaPlayer::onMetadataUpdated() is reached");
    ...
    public boolean removeDataChannel() {
        ...
        try {
            ...
            LogUtils.LOGE(TAG, "Failed to remove namespace: " + mDataNamespace, e);
        }
        return false;
        ...
        try {
            ...
            if (mState == MediaStatus.PLAYER_STATE_PLAYING) {
                ...
                if (mIdleReason == MediaStatus.IDLE_REASON_FINISHED) {
                    ...
                    makeUiHidden = true;
                    removeRemoteControlClient();
                    onFailed(com.shpark.app.castcompanionlibrary.R.string.failed_receiver_player_error, NO_STATUS_CODE);
            ...
            synchronized (mVideoConsumers) {
                for (IVideoCastConsumer consumer : mVideoConsumers) {
                    try {
                        ...
                        LogUtils.LOGE(TAG, "onRemoteMediaPlayerStatusUpdated(): Failed to inform "
                                + consumer, e);
                    }
                }
            }
    ...
    public void onRemoteMediaPlayerMetadataUpdated() {
        ...
        synchronized (mVideoConsumers) {
            for (IVideoCastConsumer consumer : mVideoConsumers) {
                try {
                    ...
                    LogUtils.LOGE(TAG, "onRemoteMediaPlayerMetadataUpdated(): Failed to inform " + consumer,
                            e);
                }
            }
        }
        ...
        try {
            ...
            LogUtils.LOGE(TAG, "Failed to update lock screen metadaa due to a network issue", e);
        } catch (NoConnectionException e) {
            LogUtils.LOGE(TAG, "Failed to update lock screen metadaa due to a network issue", e);
        }
    }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    LogUtils.LOGD(TAG, "Failed to update lock screen image", e);
                }
            }
        }).start();
    }
    ...
    private Bitmap getBitmapForLockScreen(MediaInfo video) {
            ...
            if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2) {
                if (images.size() > 1) {
                    ...
                    bm = BitmapFactory.decodeResource(mContext.getResources(),
                            com.shpark.app.castcompanionlibrary.R.drawable.dummy_album_art_large);
                }
                ...
                // we don't have a url for image so get a placeholder image from resources
                bm = BitmapFactory.decodeResource(mContext.getResources(),
                        com.shpark.app.castcompanionlibrary.R.drawable.dummy_album_art_small);
            }
        ...
        if (null != imgUrl) {
            try {
                ...
                LogUtils.LOGE(TAG, "Failed to decoded a bitmap for url: " + imgUrl, e);
            }
        }
    ...
    private void updateLockScreenMetadata() {
        ...
        try {
            ...
            mRemoteControlClientCompat.editMetadata(false)
                    ...
                    .putString(MediaMetadataRetriever.METADATA_KEY_ALBUMARTIST,
                            mContext.getResources().getString(
                                    com.shpark.app.castcompanionlibrary.R.string.casting_to_device, getDeviceName()))
            ...
            LogUtils.LOGE(TAG, "Failed to update RCC due to network issues", e);
        } catch (NoConnectionException e) {
            LogUtils.LOGE(TAG, "Failed to update RCC due to network issues", e);
        }
    }
     ...
     *
     * @param listener
     * @see com.shpark.app.castcompanionlibrary.cast.callbacks.VideoCastConsumerImpl
     */
    public synchronized void addVideoCastConsumer(IVideoCastConsumer listener) {
        if (null != listener) {
            ...
            LogUtils.LOGD(TAG, "Successfully added the new CastConsumer listener " + listener);
        }
    }
     ...
     * {@link com.shpark.app.castcompanionlibrary.widgets.MiniController.OnMiniControllerChangedListener}.
     *
    ...
    public void addMiniController(IMiniController miniController,
        ...
        if (null != miniController) {
            ...
            if (result) {
                ...
                LogUtils.LOGD(TAG, "Successfully added the new MiniController " + miniController);
            } else {
                LogUtils.LOGD(TAG, "Attempting to adding " + miniController + " but it was already " +
     ...
     * {@link com.shpark.app.castcompanionlibrary.widgets.MiniController.OnMiniControllerChangedListener} for this component.
     *
     * @param miniController
     */
    public void addMiniController(IMiniController miniController) {
    ...
    public void onFailed(int resourceId, int statusCode) {
        LogUtils.LOGD(TAG, "onFailed: " + mContext.getString(resourceId) + ", code: " + statusCode);
